'''
   ...
   This scripts made all us. It creates all the necessary folder for the project, each of one contains a personal README.md file.
   PAY ATTENTION:
   ...
   Moreover, if you have video in which extracting frames, save it in path_to_videos_folder according to thei extensions.
'''
